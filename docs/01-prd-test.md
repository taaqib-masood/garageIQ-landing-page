...
|                                                                       |
| *v1.1 --- Customer-Facing Product --- UAE Market*                     |
+-----------------------------------------------------------------------+

  -----------------------------------------------------------------------
  *This document covers the customer-facing product only. There is no
  garage-side portal or self-serve console. Admin operations (moderation,
  featured listings, overrides) are handled internally by the GarageIQ
  team. Monetization features are post-MVP scope.*
...
- Leave reviews and ratings after service
  ...
  -----------------------------------------------------------------------
  **Core value question:** Which garage is actually best for my exact car
  problem?
...
**Persona 2: Premium Car Owner**
  ...
  **Attribute**                       **Detail**
  ...
  Needs                               Specialist garage with brand
                                      expertise

  Priorities                          Brand expertise, diagnostics,
                                      quality

  Pain Point                          Wrong garage causes damage or
                                      misdiagnosis
  ----------------------------------- -----------------------------------
...
**Persona 3: Family Vehicle Manager**
  ...
  **Attribute**                       **Detail**
  ...
  Priorities                          Reliability, convenience, repeat
                                      service

  Pain Point                          No trusted long-term garage
                                      relationship
  ----------------------------------- -----------------------------------
...
**Persona 4: Car Enthusiast**
  ...
  **Attribute**                       **Detail**
  ...
  Needs                               Exact specialist with proven
                                      reputation

  Priorities                          Trusted expert, community
                                      reputation

  Pain Point                          Generic garages lack specialist
                                      knowledge
  ----------------------------------- -----------------------------------
...
**9. MVP Scope**
  ...
  -----------------------------------------------------------------------
  *Admin operations (moderation, tag overrides, featured listings,
...
contact, category, ratings, and review freshness signals.
  ...
  -----------------------------------------------------------------------
  *Limitation: Google Places API returns a maximum of \~5 reviews per
  garage. This is insufficient for AI intelligence generation on its
  own.*
...
**13. Monetisation**
  ...
  -----------------------------------------------------------------------
  *Monetisation is deferred to post-MVP. No monetisation features will be
  built or exposed to users in the MVP product. When introduced, all
  monetisation operations will be managed internally by the GarageIQ team
  via the admin console --- there is no self-serve mechanism for
  garages.*
...
**14. Risks and Mitigations**
  ...
  **Risk**              **Impact**               **Mitigation**
  ...
  Google Places API     High                     Bulk seed via
  review limit                                   Outscraper/Apify;
  (\~5/garage)                                   supplement with user
                                                 reviews over time

  Review sparsity for   Medium                   Name/category inference
  niche garages                                  as fallback; Limited
                                                 Data badge for thin
                                                 profiles

  AI misclassification  Medium                   Evidence thresholds;
  of garage                                      admin override system;
  specialisation                                 confidence scoring

  Weak early ranking    Medium                   Rules-based ranking for
  quality                                        MVP; tuned by real
                                                 search log data
                                                 post-launch

  Low initial trust in  Medium                   Show evidence count;
  AI-generated tags                              badge distinguishing AI
                                                 tag vs user-confirmed
                                                 tag

  Over-reliance on      Low-Medium               Build first-party review
  third-party review                             volume from day one
  sources                                        
  --------------------- ------------------------ ------------------------
...
with a tiered profile system:
  ...
  **Evidence Level**    **Profile Behaviour**    **UI Treatment**
  ...
  0--2 reviews          No AI tags generated     \"New listing\" badge,
                                                 basic info only

  3--4 reviews          Partial tags only (high  \"Limited data\" badge
                        confidence signals)      shown

  5--14 reviews         Standard tag generation  Tags shown, confidence
                        with lower confidence    visible

  15+ reviews           Full intelligence        Complete profile, no
                        profile generated        badge
  --------------------- ------------------------ ------------------------
...
**17. Product Success Criteria**
  ...
  -----------------------------------------------------------------------
  **Success definition:** GarageIQ succeeds when users consistently feel:
  "This helped me find the right garage faster and with less risk than
  Google."
